...
/**
 * Form de un user_task (V015); entitydefId = FK lógica cross-service a system.sys_entity_def.
...
public class Taskform {
    ...
    private final UUID entitydefId;
    ...
    public Taskform(UUID id, UUID tenantId, UUID flowelementId, UUID entitydefId, String mode, UUID stateId,
