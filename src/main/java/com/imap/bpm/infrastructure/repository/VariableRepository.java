...
import com.imap.bpm.infrastructure.entity.VariableEntity;
...
public interface VariableRepository extends JpaRepository<VariableEntity, UUID> {
    Optional<VariableEntity> findByProcessinstanceIdAndVarName(UUID processinstanceId, String varName);
    List<VariableEntity> findByProcessinstanceId(UUID processinstanceId);
