...
/**
 * JPA entity para bpm.bpm_pro_tenant_process_tbl — overlay de procesos por tenant
 * (gemelo de acc_tenant_account del plan de cuentas). Nivel 1 (enabled) + Nivel 2 (config).
 * Ver IMAP_BPM_PROCESS_CATALOG.md §1.
 */
@Entity
@Table(name = "bpm_pro_tenant_process_tbl")
public class TenantProcessEntity {
    ...
    @Column(name = "processdef_code", nullable = false)
    ...
    public TenantProcessEntity() {}

    public UUID getId()                        { return id; }
    public void setId(UUID id)                 { this.id = id; }
    public UUID getTenantId()                  { return tenantId; }
    public void setTenantId(UUID id)           { this.tenantId = id; }
    public String getProcessdefCode()          { return processdefCode; }
    public void setProcessdefCode(String s)    { this.processdefCode = s; }
    public boolean isEnabled()                 { return enabled; }
    public void setEnabled(boolean b)          { this.enabled = b; }
    public Map<String, Object> getConfig()     { return config; }
    public void setConfig(Map<String, Object> c){ this.config = c; }
